...
<meta charset="utf-8">
  ...
  <link href="vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    ...
    <!--Fullcalendar-->
    <link rel="stylesheet" href="<?=$dir;?>scripts/main.css">
    <script src="<?=$dir;?>scripts/main.js"></script>
    <script src="<?=$dir;?>scripts/es.js"></script>
    ...
    <link rel="stylesheet" href="<?=$dir;?>scripts/jquery.datetimepicker.min.css">
    <script src="<?=$dir;?>scripts/jquery.datetimepicker.full.js"></script>

    <link rel="stylesheet" href="<?=$dir;?>packages/colorpicker/bootstrap-colorpicker.css">
    <script src="<?=$dir;?>packages/colorpicker/bootstrap-colorpicker.js"></script>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Agenda de Eventos</h1>
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div id="edit-title-group" class="form-group">
                                      <label class="control-label" for="editEventTitle">Asunto</label>
                                      <input type="text" class="form-control" id="editEventTitle" name="editEventTitle">
                                      <!-- errors will go here -->
                                  </div>

                                  <div id="edit-startdate-group" class="form-group">
                                      <label class="control-label" for="editStartDate">Fecha de inicio</label>
                                  ...
                                  <div id="edit-enddate-group" class="form-group">
                                      <label class="control-label" for="editEndDate">Fecha de termino</label>
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div id="edit-textcolor-group" class="form-group">
                                      <label class="control-label" for="editTextColor">Color de texto</label>
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="deleteEvent" data-id>Eliminar</button>
                  </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="enddate-group" class="form-group">
                                <label class="control-label" for="endDate">Fecha de termino</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div id="textcolor-group" class="form-group">
                                <label class="control-label" for="textcolor">Color de texto</label>
