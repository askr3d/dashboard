...
<body id="page-top">
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Suricata Chart</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  <div class="chart-pie pt-4">
                  ...
                  <hr>
                  Styling for the donut chart can be found in the <code>/js/demo/chart-pie-suricata.js</code> file.
                </div>
              </div>
            </div>
  ...
  <script src="js/demo/chart-pie-suricata.js"></script>
