      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <!-- Nav Item - Alerts -->
            <li id="notificaciones_boton" class="nav-item dropdown no-arrow mx-1">
              <a id="evitarEvento" class="nav-link dropdown-toggle"role="button">
                <i class="fas fa-bell fa-fw"></i>
                <!-- Counter - Alerts -->
                <span id="notificaciones" class="badge badge-danger badge-counter">3+</span>
              </a>
              <!-- Dropdown - Alerts -->
              <div id="dropEvent" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small nombrePerfil"><?php echo ucwords($nombre);?></span>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 nombreCompleto"><?php echo ucwords($nombreCompleto) ?></h1>
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
          </div>
          <div class="jumbotron jumbotron-fluid">
            <div class="container">
              <h2 class="display-5">Datos personales</h2><br>
              <table id="tablaDatos" class="table table-sm table-striped table-active">
                <thead>
                  <tr>
                    <td>Nombre</td>
                    <td>
                      ...
                      <i class='bx bx-edit editar cancelarEvento' style='color:#00add0'  ></i>
                    </td>
                  </tr>
                  <tr>
                    <td>Apellidos</td>
                    <td>
                      <input type="hidden" value="apellido">
                      <label><?php echo $row['apellido']?></label>
                      <i class='bx bx-edit editar cancelarEvento' style='color:#00add0'  ></i>
                    </td>
                  </tr>
                  <tr>
                    <td>Correo</td>
                    <td>
                      <input type="hidden" value="correo">
                      <label><?php echo $row['correo'];?></label>
                      <i class='bx bx-edit editar cancelarEvento' style='color:#00add0'  ></i>
                    </td>
                  </tr>
                  <tr>
                    <td>Contraseña</td>
                    <td><a class="cancelarEvento" id="pass" href="">Cambiar contraseña</a></td>
                  </tr>
                  <tr>
                ...
                <tfoot>
                  <tr>
                    <td colspan="2">
                      <center>
                        <div id="cuadroImagen">
                          <img id="imagen" src="<?php echo $ruta;?>" alt="Selecciona una imagen" width="250px"><br><br>
                        </div>
                      </center>
                    </td>
                  </tr>
...
-->              
  ...
  <script src="perfiles/scripts/editar.js"></script>
  <script src="notifications/load.js"></script>
