...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">VNware</h1>
              ...
              <div class="modal-body bg-secondary">
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="VNware" id="VNwarem" required>
                        </div>
                        <div class="col-md-6 mb-3">
                              <label for="power">power</label>
                              <select class="custom-select" name="power" id="powerm" required>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="DNS" id="DNSm" required>
                        </div>
                        <div class="col-md-6 mb-3">
                              <label for="conection">conection</label>
                              <select class="custom-select" name="conection"m id="conectionm" required>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="CPUs" id="CPUsm" required>
                        </div>
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label for="memory">memory</label>
                            <input type="text" class="form-control" name="memory" id="memorym" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            <label for="IPadress">IPadress</label>
                            <input type="text" class="form-control" name="IPadress" id="IPadressm" required>
                        </div>
                    </div>
                  </div>
  ...
  <script src="js/sb-admin-2.min.js"></script>
    ...
    <!--Datatable-->
    <script src="VNware/scripts/datatable.js"></script>
    <?php if($nivel<3){?>
    <!--Agregar-->
    <script src="VNware/scripts/agregar.js"></script>
    <!--Editar-->
    <script src="VNware/scripts/editar.js"></script>
    <!--Borrar-->
    <script src="VNware/scripts/borrar.js"></script>
    <?php }?>
